#+OPTIONS:   H:5 title:nil num:nil toc:nil \n:t @:t ::nil |:t ^:nil -:t f:nil *:t <:t
#+LATEX_HEADER: 
#+LATEX_HEADER: \pagenumbering{}
#+LATEX_HEADER: \usepackage{titling}\setlength{\droptitle}{-10em}
...
#+LATEX_HEADER: \renewcommand\maketitle{\begin{center}\vspace*{-3cm}\textbf{\Large Alick Mitchell\\\normalsize tel: 07821 486241 email: mitchell.alick@gmail.com\end{center}}}

#+BEGIN_LaTeX
\raggedright\textfb{\Large Personal Summary}\\
I am a dedicated and forward thinking individual, who enjoys developing my skill set to produce a more efficient working environment. I'm constantly look to solidifying my foundational knowledge whilst developing new skills. I enjoy working in close teams but have the ability and initiative to work alone.\\
\hspace*{.5cm}
#+END_LaTeX

#+BEGIN_LaTeX
\raggedright\textfb{\Large Technical}\\
\textbf{System Administration}\\
\hspace*{.5cm} - Debian, Ubuntu, REHL, FreeBSD\\
\textbf{Programming Languages}\\
\hspace*{.5cm}- C, Perl, Python, Bash, Scheme\\
\textbf{Web Services}\\
\hspace*{.5cm}- Apache, Nginx, HAProxy\\ 
\textbf{Web Frameworks}\\
\hspace*{.5cm}- Django, Flask, Jekyll, Wordpress\\
\textbf{Database}\\
\hspace*{.5cm}- MySQL, PostgreSQL, SQLite3, MongoDB\\
\textbf{Mail}\\
\hspace*{.5cm}- Postfix, Dovecot, exim, qmail\\
\textbf{Networking}\\
\hspace*{.5cm}- Implementation of the following DNS/BIND, DHCP, VPN, SSH, FTP,\\ 
\hspace*{.7cm}CUPS, NFS, Samba, VOIP, SSL/TLS\\
\textbf{Cloud Technologies \& Virtualization}\\
\hspace*{.5cm}- OpenStack, OpenShift, Kubernetes, KVM, Docker, Vagrant\\
\textbf{Storage}\\
\hspace*{.5cm}- DRBD, Ceph, Gluster, Swift\\
\textbf{Monitoring \& Automation}\\
\hspace*{.5cm}- Zabbix, Nagios, Ansible\\
\textbf{Misc Technologies}\\
\hspace*{.5cm}- SELinux, Git, Wireshark, Cisco IOS, Emacs, Asterisk\\
\hspace*{.5cm}
#+END_LaTeX

#+BEGIN_LaTeX
\raggedright\textfb{\Large Employment}\\
% Title
...
#+BEGIN_LaTeX
\raggedright\textfb{\Large Education}\\
...
#+BEGIN_LaTeX
\raggedright\textfb{\Large Additional Information}\\
