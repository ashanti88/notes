...
** RHEL7 Installing PHP7.*
- [[http://php.net/manual/en/migration70.php][Migrating from PHP 5.6.x to PHP 7.0.x]]
- [[http://php.net/manual/en/migration71.php][Migrating from PHP 7.0.x to PHP 7.1.x]]
...
- if you want the new PHP-opcache
#+BEGIN_SRC sh
yum install php70w-opcache
#+END_SRC

- if you need the PHP-cli
#+BEGIN_SRC sh
...
- if you want to use the new PHP-opcache
#+BEGIN_SRC sh
