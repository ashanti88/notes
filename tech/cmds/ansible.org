...
*** Lesson Five  - Creating Lab Servers
...
*** Lesson Six   - These are the core components in Ansible
...
*** Lesson Seven - What is an ad-hoc command
...
*** Lesson Eight - Ad-hoc commands continued
- ping all machines
#+BEGIN_SRC sh
ansible all -m ping
#+END_SRC
...
*** Lesson Nine  - Further Discussions about the ansible command
...
*** Lesson Ten   - Overview of Static and Dynamic Inventories in Ansible 
